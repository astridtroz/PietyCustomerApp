...
import '/UILayer/Screens/StoreDescriptionScreens/StoreGallery.dart';
import '/UILayer/Screens/StoreDescriptionScreens/StoreNameReviewText.dart';
import '/UILayer/Screens/StoreDescriptionScreens/StoreTimingsText.dart';
...
//                                           stream:
//                                               _storeBloc!.singleRateListStream,
//                                           initialData:
//                                               _storeBloc!.getInitialRateList,
//                                           builder: (context, snapshot) {
//                                             if (snapshot.hasData) {
//                                               RateList fetchedRateList =
//                                                   snapshot.data!;
//                                               List<RateListItem> fetchedList =
//                                                   fetchedRateList.rateListItem;
...
//                                 stream: _storeBloc!.allServicesStream,
//                                 initialData: _storeBloc!.getAllServices,
//                                 builder: (context, snapshot) {
//                                   return Container(
...
//                                                                         child:
//                                                                             FilterChip(
//                                                                           backgroundColor: _selectedText.contains(item)
//                                                                               ? Colors.amber
//                                                                               : Colors.white30,
//                                                                           label:
//                                                                               Text(
//                                                                             item,
//                                                                           ),
//                                                                           avatar: _selectedText.contains(item)
//                                                                               ? Icon(Icons.done)
//                                                                               : Icon(Icons.add),
//                                                                           onSelected:
//                                                                               (value) {
                                                                      ...
                                                                      onTap: () {
                                                                        Scaffold.of(context)
                                                                          ...
                                                                          _storeBloc!.mapEventToState(GetRateListOfType(
                                                                              rateListType: "All",
                                                                              storeID: _storeBloc!.getSingleStore.uid!));

                                                                          return Padding(
                                                                              padding: const EdgeInsets.all(8.0),
                                                                              child: StatefulBuilder(builder: (BuildContext context, StateSetter mySetState) {
                                                                      ...
                                                                      builder:
                                                                        ...
                                                                        if (snapshot
                                                                          ...
                                                                          if (snapshot
                                                                            ...
                                                                            return snapshot.data!.offers?.length == 0
                                                                                ? Container(
                                                                    ...
                                                                    child: StreamBuilder<
                                                                        ...
                                                                        builder:
                                                                          ...
                                                                          List<charts.Series<ComparisionChartData, String>>
                                                                              seriesList =
                                                                              [
                                                                            charts.Series<ComparisionChartData,
                                                                                String>(
                                                                              id: 'Chart',
                                                                              colorFn: (_, __) => charts.MaterialPalette.cyan.shadeDefault,
                                                                              domainFn: (ComparisionChartData comp, _) => comp.storeName,
                                                                              measureFn: (ComparisionChartData comp, _) => comp.minOrderAmount,
                                                                              data: myData,
                                                                            )
                                                                          ];
                                                                          if (snapshot
                                                              ...
                                                              child: snapshot
                                                                  ...
                                                                  Center(
                                                                      child:
                                                                        ...
                                                                        style: ButtonStyle(
                                                                            shape:
                                                                                MaterialStateProperty.all<RoundedRectangleBorder>(RoundedRectangleBorder(borderRadius: BorderRadius.circular(0.0), side: BorderSide(color: Colors.lightBlueAccent)))),
                                                                        child:
                                                                            Text(
                                                                          "Select Services",
                                                                          style:
...
//                                                                             bool
//                                                                                 toAdd =
//                                                                                 _selectedText.contains(item.serviceName);
//                                                                             if (_selectedText.length ==
//                                                                                 0) {
//                                                                               _numberOfItems[item.serviceName] = 0;
//                                                                               _prices[item.serviceName] = rate.fixed;
//                                                                             }
//                                                                             if (_searchField == "All" ||
//                                                                                 _searchField == item.serviceName) {
//                                                                               Widget card = buildCard(item.serviceName, rate.fixed, item.imageUrl, toAdd, context, _numberOfItems[item.serviceName]);
//                                                                               cards.add(card);
//                                                                             }
//                                                                           });
// //                                                print(cards.toString());
