                                ...
                                if (_store!.storeType == "Laundry") {
                                  List<Location> location =
                                      await locationFromAddress(_userBloc!
                                          ...
                                          .toString());
                                  var latx = location[0];
                                  var phone = _user!.phoneNumbers != null ? _user!.phoneNumbers![0].toString() : "Guest User";
                                  UserAddress orderAddress = UserAddress(
                                      city: _userBloc!
                                          .getSelectedUserAddress?.city,
                                      name: _userBloc!.getSelectedUserAddress?.name != null ? _userBloc!.getSelectedUserAddress?.name.toString() : phone,
